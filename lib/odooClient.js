...
export async function fetchOdooStock() {
  ...
  // Echte artikelcodes eindigen altijd op een punt (bv. "3M005.50D4D4.").
  // Zonder dit filter haalt Odoo ~7000 producten op (inclusief duizenden
  // lege/dubbele testvarianten), wat traag is en af en toe een artikel
  // leek te laten "verdwijnen" uit het antwoord.
